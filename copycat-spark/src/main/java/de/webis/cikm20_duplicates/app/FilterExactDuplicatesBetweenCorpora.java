...
public class FilterExactDuplicatesBetweenCorpora {
	public static void main(String[] args) {
		try (JavaSparkContext context = context()) {
			JavaRDD<String> input = context.textFile("ecir2021/cw09-cw12-cc15-onegram-deduplication/min-length-10-/64BitK3SimHashOneGramms/exact-duplicates");
			
			exactDuplicatesBetweenCorporaWithJudgments(input)
				.saveAsTextFile("ecir2021/cw09-cw12-cc15-onegram-deduplication/min-length-10-/64BitK3SimHashOneGramms/distinct-exact-duplicates-between-corpora-for-relevance-transfer", BZip2Codec.class);
		}
	}
