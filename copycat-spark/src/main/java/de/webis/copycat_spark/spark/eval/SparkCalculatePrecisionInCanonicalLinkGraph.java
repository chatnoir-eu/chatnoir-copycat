...
import de.webis.copycat_spark.spark.eval.SparkEvaluateSimHashFeatures.FeatureSetCandidate;
...
//	}
	...
	public static class TwoDocsForFeatureWithS3Score implements Serializable {
		...
		@SneakyThrows
		public static TwoDocsForFeatureWithS3Score fromString(String src) {
			return new ObjectMapper().readValue(src, TwoDocsForFeatureWithS3Score.class);
		}
	}
