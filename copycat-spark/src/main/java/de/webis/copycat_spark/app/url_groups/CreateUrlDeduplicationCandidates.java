...
public class CreateUrlDeduplicationCandidates {
	...
	/**
	 * This mapping ensures that I can reuse {@link de.webis.copycat_spark.spark.SparkCreateDeduplicationCandidates#exactDuplicates} (additionally, it is tested in multiple integration tests that this mapping works as expected).
