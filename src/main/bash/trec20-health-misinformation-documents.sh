...
/home/kibi9872/web-search-cikm2020-resource-paper-code/local-spark/bin/spark-submit \
        ...
        --deploy-mode cluster \
        --class de.webis.cikm20_duplicates.app.ExtractHealthMisinformationDocuments \
        --conf spark.default.parallelism=${PARALLELISM}\
        --num-executors ${PARALLELISM}\
        --driver-memory 15G\
        target/cikm20-duplicates-1.0-SNAPSHOT-jar-with-dependencies.jar \
		--input s3a://corpus-commoncrawl-news-health-misinformation/crawl-data/CC-NEWS/2020/*/*.warc.gz \
		--inputFormat COMMON_CRAWL \
		--output trec2020/health-misinformation-collection-documents
