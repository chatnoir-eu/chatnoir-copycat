...
public class DeduplicateTrecRunFileIntegrationTest {
	...
	public void testOnRunFileWithSingleDuplicatesWithinSingleTopic() {
		...
		List<String> expected = Arrays.asList(
			"{\"topic\":\"1\",\"similarities\":[{\"firstId\":\"clueweb09-en0058-20-30937\",\"secondId\":\"clueweb09-en0060-58-25055\",\"similarities\":{\"s3\":0.875,\"cosine(1-grams)\":0.9868972,\"cosine(8-grams)\":0.8750517,\"cosine(3+5-grams)\":0.92026484,\"url\":0.0,\"simhash(1-grams)\":0.953125,\"simhash(3+5-grams)\":0.96875}}],\"docs\":2}"
		);
	...
	public void testOnRunFileWithMultipleDuplicatesWithinSingleTopic() {
		...
		List<String> expected = Arrays.asList(
				"{\"topic\":\"1\",\"similarities\":[{\"firstId\":\"clueweb09-en0058-20-30937\",\"secondId\":\"clueweb09-en0060-58-25055\",\"similarities\":{\"s3\":0.875,\"cosine(1-grams)\":0.9868972,\"cosine(8-grams)\":0.8750517,\"cosine(3+5-grams)\":0.92026484,\"url\":0.0,\"simhash(1-grams)\":0.953125,\"simhash(3+5-grams)\":0.96875}}],\"docs\":3}");
