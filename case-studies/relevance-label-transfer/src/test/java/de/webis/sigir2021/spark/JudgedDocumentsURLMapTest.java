...
public class JudgedDocumentsURLMapTest extends SparkIntegrationTestBase {
	@Test
	public void test() {
		List<String> expected = Arrays.asList(
			"clueweb09-en0000-00-00142", "clueweb09-en0000-00-00175",
			"clueweb09-en0000-00-00278", "clueweb09-en0000-00-00279",
			"clueweb09-en0000-00-01005", "clueweb09-en0000-00-01382",
			"clueweb09-en0000-00-01383", "clueweb09-en0000-00-01559",
			"clueweb09-en0000-00-01836", "clueweb09-en0000-00-02122"
		);
		List<String> judgedDocs = JudgedDocumentsInDocumentRepresentations.judgedCW09WebDocuments();
		
		Assert.assertEquals(72699l, judgedDocs.size());
		Assert.assertEquals(expected, judgedDocs.subList(0, 10));
	}
	...
	public void test2() {
		...
		Map<String, String> docIdToUrl = JudgedDocumentsInDocumentRepresentations.docIdToUrl(jsc(), input, 1);
		
		Approvals.verifyAsJson(docIdToUrl);
	}
	...
	public void bla() {
		...
		Map<String, String> docIdToUrl = JudgedDocumentsInDocumentRepresentations.docIdToUrl(jsc(), input, 1);
		Map<String, String> actual = JudgedDocumentsInDocumentRepresentations.docIdToUrl(testDocumentsWithoutCanonicalLinks(), docIdToUrl);
	...
	private JavaRDD<String> testDocumentsWithoutCanonicalLinks() {
		return jsc().parallelize(Arrays.asList(
			...
			"{\"docId\":\"clueweb09-en0000-00-00142\",\"url\":\"http://www.mcprod.com.br/geometry/_images/yampa-canyon-river-rafting/jugar-directamente-a-los-sims.html\",\"canonicalURL\":null,\"fingerprints\":{\"64BitK3SimHashOneGramms\":[-1421934592,5876,11403496,4329984],\"64BitK3SimHashThreeAndFiveGramms\":[-1729363968,42164,15532128,11390976]},\"crawlingTimestamp\":\"2012-02-17T19:31:40Z\",\"documentLengthInWords\":1868,\"documentLengthInWordsWithoutStopWords\":1350}",
			...
			"{\"docId\":\"clueweb09-ja0015-28-30773\",\"url\":null,\"canonicalURL\":null,\"fingerprints\":{\"64BitK3SimHashOneGramms\":[-1543438336,24026,11665482,7964416],\"64BitK3SimHashThreeAndFiveGramms\":[1518665728,21494,5439702,8982528]},\"crawlingTimestamp\":\"2009-03-85T07:15:59-0700\",\"documentLengthInWords\":21,\"documentLengthInWordsWithoutStopWords\":227}"
