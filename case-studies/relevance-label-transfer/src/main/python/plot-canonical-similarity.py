...
infiles = {
    "src/main/resources/canonical-edges-s3-aggregations-cc-2015-11.json": "CC 15",
    "src/main/resources/canonical-edges-s3-aggregations-cw09.json": "CW 09",
    "src/main/resources/canonical-edges-s3-aggregations-cw12.json": "CW 12"
}
...
g = sns.lineplot(data=df, x='$S_{3}$ Score', y='Ratio', style="Corpus", color='k', style_order=["CW 09", "CW 12", "CC 15"])
