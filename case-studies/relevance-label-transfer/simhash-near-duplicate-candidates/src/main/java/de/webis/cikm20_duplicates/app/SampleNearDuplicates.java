...
public class SampleNearDuplicates {
	...
	private static ArgumentParser argParser() {
		...
		ret.addArgument("-i", "--" + ArgumentParsingUtil.ARG_INPUT).required(Boolean.TRUE).help(
				"The prefix of the input path that contains the required directories (e.g. for `--"+ ArgumentParsingUtil.ARG_INPUT +" sigir2021/cw09-deduplication/min-length-10` it will use `sigir2021/cw09-deduplication/min-length-10-exact-duplicates` and `sigir2021/cw09-deduplication/min-length-10-near-duplicates`)");
